...
import numpy as np
import sys
from .transforms import rotation_to_euler, euler_to_rotation
from .logger import Logger
try:
    import bpy
except ImportError:
    # print("Unable to import bpy! Please install it manually if required", file=sys.stderr)
    pass
